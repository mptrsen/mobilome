...
PREFIX='/share/pool/user/analyses/results/te-annotation' # used to compose output directory by appending SPECIES
DRY_RUN=0
RUN_MODELER=1
FILTER_LIBRARY=1
RUN_MASKER=1
...
LANDSCAPEPARSER='/home/user/scripts/parse-repeatmasker-landscapes-to-table.pl'
LIBRARYFILTER='/share/pool/user/analyses/code/reallyrepeats.sh'
FASTAGREP='/home/user/scripts/fastagrep.pl'
